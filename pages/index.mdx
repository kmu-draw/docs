...
![시스템 구성 다이어그램](/images/architecture-diagram.jpg)
...
export const Profile = ({ src, alt }) => {
  return (
    <div style={{ width: "fit-content", borderRadius: "50%", overflow: "hidden" }}>
      <Image src={src} alt={alt} width={150} height={150} />
    </div>
  );
};

<div style={{ marginTop: "24px", display: "flex", flexWrap: "wrap", gap: "32px" }}>
  <div style={{ width: "220px", display: "flex", flexDirection: "column", alignItems: "center" }}>
    <Profile src="/images/profile_jaewook.jpg" alt="Jaewook Ahn" />
    <p style={{ marginTop: "8px", fontSize: "28px" }}>안재욱</p>
    <p>Frontend</p>
    <div style={{ display: "flex", alignItems: "center" }}>
      <AiFillGithub />
      <a style={{ marginLeft: "4px" }} href="https://github.com/Jaewoook" target="_blank">Jaewoook</a>
    </div>
    <div style={{ display: "flex", alignItems: "center" }}>
      <AiOutlineMail />
      <span style={{ marginLeft: "4px" }}>dev.jaewook@gmail.com</span>
    </div>
  </div>
  <div style={{ width: "220px", display: "flex", flexDirection: "column", alignItems: "center" }}>
    <Profile src="/images/profile_seungjin.jpg" alt="Seungjin Han" />
    <p style={{ marginTop: "8px", fontSize: "28px" }}>한승진</p>
    <p>Machine Learning</p>
    <div style={{ display: "flex", alignItems: "center" }}>
      <AiFillGithub />
      <a style={{ marginLeft: "4px" }} href="https://github.com/LEFT-BEE" target="_blank">LEFT-BEE</a>
    </div>
    <div style={{ display: "flex", alignItems: "center" }}>
      <AiOutlineMail />
      <span style={{ marginLeft: "4px" }}>gkstmdwls1999@gmail.com</span>
    </div>
  </div>
</div>
